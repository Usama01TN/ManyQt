...
version = '0.0.2'  # type: str
# The full version, including alpha/beta/rc tags.
release = '0.0.2'  # type: str
...
latex_documents = [
    (master_doc, 'ManyQt.tex', 'ManyQt Documentation', 'manual'),
]
...
man_pages = [
    (master_doc, 'manyqt', 'ManyQt Documentation',
     [], 1)
]
...
texinfo_documents = [
    (master_doc, 'ManyQt', 'ManyQt Documentation',
     'ManyQt', 'One line description of project.',
     'Miscellaneous'),
]
